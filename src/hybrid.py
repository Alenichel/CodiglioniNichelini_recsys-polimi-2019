...
if __name__ == '__main__':
    ...
    cf_rec2 = ItemCFKNNRecommender(fallback_recommender=cbf_rec)
    cf_rec2.fit(urm_train, top_k=5, shrink=35, similarity='cosine')
    rec = HybridRecommender([cf_rec, cf_rec2], [0.5,0.5])
    if EXPORT:
...
if __name__ == '__main__':
    ...
    for x in range(ROUND):
        ...
        rec = HybridRecommender([cf_rec1, cf_rec2, cf_rec3], merging_type=MergingTechniques.WEIGHTS, weights=[1/3, 1/3, 1/3])
